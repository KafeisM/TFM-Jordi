...
\texttt{rl\_uav/evaluation/} & Protocolo de evaluación por semillas con controladores enchufables (PPO y PID). \\
\texttt{scripts/evaluate\_policy.py} & Punto de entrada de la evaluación formal y de la comparación entre controladores. \\
...
aplica además un reciclado preventivo: interrumpe el entrenamiento a intervalos
