...
\usepackage[
  ...
  pdftitle={Trabajo Fin de Máster},
  pdfborder={0 0 0}
]{hyperref}
\usepackage{pdfpages}
\usepackage{url}
...
% --- BIBLIOGRAPHY ---
% The TFM writing guide recommends an author-year style, preferably similar to
% APA, and an alphabetically ordered bibliography instead of numeric references.
\usepackage[
  backend=biber,
  style=authoryear,
  sorting=nyt,
...
% Los pies de figuras y tablas se separan visualmente del cuerpo del texto.
% Con la opción de 11 pt de la clase book, \footnotesize equivale a 9 pt.
